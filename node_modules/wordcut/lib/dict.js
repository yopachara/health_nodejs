...
var WordcutDict = {
  init: function(dictPathFile) {
    ...
    if (dictPathFile === undefined) {
      dictPath = [ __dirname + "/../data/tdict-acronyms.txt",
                   __dirname + "/../data/tdict-city.txt",
                   __dirname + "/../data/tdict-collection.txt",
                   __dirname + "/../data/tdict-common.txt",
                   __dirname + "/../data/tdict-country.txt",
                   __dirname + "/../data/tdict-district.txt",
                   __dirname + "/../data/tdict-geo.txt",
                   __dirname + "/../data/tdict-history.txt",
                   __dirname + "/../data/tdict-ict.txt",
                   __dirname + "/../data/tdict-lang-ethnic.txt",
                   __dirname + "/../data/tdict-proper.txt",
                   __dirname + "/../data/tdict-science.txt",
                   __dirname + "/../data/tdict-spell.txt",
                   __dirname + "/../data/tdict-std.txt",
                   __dirname + "/../data/tdict-std-compound.txt"];
    ...
    for(var i=0;i<dictPath.length;i++){
      this.dict = this.dict
        .concat(fs
          .readFileSync(dictPath[i], {encoding: "UTF-8"})
          .split(/[\r\n]+/)
